...
from fdk_rdf_parser_service.parser.classes.evidence import Evidence, EvidenceRdfType
...
from fdk_rdf_parser_service.parser.rdf_utils.utils import value_list
