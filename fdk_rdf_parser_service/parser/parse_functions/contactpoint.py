...
from fdk_rdf_parser_service.parser.classes import CVContactPoint, DCATContactPoint
from fdk_rdf_parser_service.parser.parse_functions.opening_hours_specification import (
