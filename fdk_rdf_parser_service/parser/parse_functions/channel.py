...
from fdk_rdf_parser_service.parser.classes import Channel
from fdk_rdf_parser_service.parser.parse_functions.address import extract_address
from fdk_rdf_parser_service.parser.rdf_utils import object_value, resource_list
from fdk_rdf_parser_service.parser.rdf_utils.ns import cpsv_uri, cv_uri, vcard_uri
from fdk_rdf_parser_service.parser.rdf_utils.utils import (
