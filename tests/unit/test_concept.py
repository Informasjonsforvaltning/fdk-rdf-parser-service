...
from fdk_rdf_parser_service.parser import parse_concepts
...
from fdk_rdf_parser_service.parser.classes.concept import (
    AssociativeRelation,
    Collection,
    Definition,
    GenericRelation,
...
from fdk_rdf_parser_service.parser.parse_functions import parse_concept
