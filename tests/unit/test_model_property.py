...
from fdk_rdf_parser_service.parser.classes import InformationModel
from fdk_rdf_parser_service.parser.classes.model_property import ModelProperty
from fdk_rdf_parser_service.parser.parse_functions.model_property import (
