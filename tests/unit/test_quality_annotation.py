...
from fdk_rdf_parser_service.parser.classes import QualityAnnotation
from fdk_rdf_parser_service.parser.parse_functions import extract_quality_annotation
from fdk_rdf_parser_service.parser.rdf_utils import dqv_iso_uri
