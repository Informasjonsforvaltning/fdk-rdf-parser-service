...
from fdk_rdf_parser_service.parser.classes import SkosConcept
from fdk_rdf_parser_service.parser.parse_functions import extract_skos_concept
from fdk_rdf_parser_service.parser.rdf_utils import dcat_ap_no_uri
